...
define %Dummy* @Dummy_new() {
  ...
  ;; default-initializing field 'dummyX'
...
define %Child* @Child_new() {
  ...
  %r4 = call %Int* @Int_new()
  store %Int* %r4, %Int** %r3
  ;; default-initializing field 'childX'
  %r5 = getelementptr %Child, %Child* %r1, i32 0, i32 2
  %r6 = call %Int* @Int_new()
  store %Int* %r6, %Int** %r5
  ;; default-initializing field 'childY'
  %r7 = getelementptr %Child, %Child* %r1, i32 0, i32 3
  store %Child* null, %Child** %r7
  ;; default-initializing field 'childZ'
  %r8 = getelementptr %Child, %Child* %r1, i32 0, i32 4
  store %Dummy* null, %Dummy** %r8
  ret %Child* %r1
}
...
define %GrandChild* @GrandChild_new() {
  ...
  store %Child* null, %Child** %r7
  ;; default-initializing field 'childZ'
  %r8 = getelementptr %GrandChild, %GrandChild* %r1, i32 0, i32 4
  store %Dummy* null, %Dummy** %r8
  ;; default-initializing field 'grandChildX'
  %r9 = getelementptr %GrandChild, %GrandChild* %r1, i32 0, i32 5
  %r10 = call %Int* @Int_new()
  store %Int* %r10, %Int** %r9
  ;; default-initializing field 'grandChildY'
  %r11 = getelementptr %GrandChild, %GrandChild* %r1, i32 0, i32 6
  %r12 = call %String* @String_new()
  store %String* %r12, %String** %r11
  ;; default-initializing field 'grandChildZ'
  %r13 = getelementptr %GrandChild, %GrandChild* %r1, i32 0, i32 7
  store %Sibling* null, %Sibling** %r13
  ret %GrandChild* %r1
}
...
define %Sibling* @Sibling_new() {
  ...
  ;; default-initializing field 'dummyX'
  %r3 = getelementptr %Sibling, %Sibling* %r1, i32 0, i32 1
  %r4 = call %Int* @Int_new()
  store %Int* %r4, %Int** %r3
  ;; default-initializing field 'siblingX'
  %r5 = getelementptr %Sibling, %Sibling* %r1, i32 0, i32 2
  %r6 = call %Int* @Int_new()
  store %Int* %r6, %Int** %r5
  ;; default-initializing field 'siblingY'
  %r7 = getelementptr %Sibling, %Sibling* %r1, i32 0, i32 3
  store %Child* null, %Child** %r7
  ret %Sibling* %r1
}
...
define %Cousin* @Cousin_new() {
  ...
  ;; default-initializing field 'dummyX'
  %r3 = getelementptr %Cousin, %Cousin* %r1, i32 0, i32 1
  %r4 = call %Int* @Int_new()
  store %Int* %r4, %Int** %r3
  ;; default-initializing field 'siblingX'
  %r5 = getelementptr %Cousin, %Cousin* %r1, i32 0, i32 2
  %r6 = call %Int* @Int_new()
  store %Int* %r6, %Int** %r5
  ;; default-initializing field 'siblingY'
  %r7 = getelementptr %Cousin, %Cousin* %r1, i32 0, i32 3
  store %Child* null, %Child** %r7
  ;; default-initializing field 'cousinX'
  %r8 = getelementptr %Cousin, %Cousin* %r1, i32 0, i32 4
  store %Cousin* null, %Cousin** %r8
  ret %Cousin* %r1
}
...
define %Cousin2* @Cousin2_new() {
  ...
  ;; default-initializing field 'dummyX'
  %r3 = getelementptr %Cousin2, %Cousin2* %r1, i32 0, i32 1
  %r4 = call %Int* @Int_new()
  store %Int* %r4, %Int** %r3
  ;; default-initializing field 'siblingX'
  %r5 = getelementptr %Cousin2, %Cousin2* %r1, i32 0, i32 2
  %r6 = call %Int* @Int_new()
  store %Int* %r6, %Int** %r5
  ;; default-initializing field 'siblingY'
  %r7 = getelementptr %Cousin2, %Cousin2* %r1, i32 0, i32 3
  store %Child* null, %Child** %r7
  ret %Cousin2* %r1
}
...
define %Main* @Main_new() {
  ...
  ;; default-initializing field 'io'
  %r3 = getelementptr %Main, %Main* %r1, i32 0, i32 1
  store %IO* null, %IO** %r3
  ;; initializing field 'io'
  %r4 = call %IO* @IO_new()
  %r5 = getelementptr %Main, %Main* %r1, i32 0, i32 1
  store %IO* %r4, %IO** %r5
  ret %Main* %r1
}
