...
entry_0:
  %r0 = icmp eq %Int* @int_15, null
  ;; boxing i1 %r0
  %r1 = call %Bool* @Bool_new()
  %r2 = getelementptr %Bool, %Bool* %r1, i32 0, i32 1
  store i1 %r0, i1* %r2
  ;; emitting an 'if'
  %r3 = alloca %Int*
  ;; unboxing %Bool* %r1
  %r4 = getelementptr %Bool, %Bool* %r1, i32 0, i32 1
  %r5 = load i1, i1* %r4
  br i1 %r5, label %then_1, label %else_2
then_1:
  store %Int* @int_99, %Int** %r3
  br label %ifend_3
else_2:
  store %Int* @int_42, %Int** %r3
  br label %ifend_3
ifend_3:
  %r6 = load %Int*, %Int** %r3
  ret %Int* %r6
