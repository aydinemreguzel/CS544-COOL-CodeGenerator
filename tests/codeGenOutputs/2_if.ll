...
@str_3 = constant [6 x i8] c"hello\00";
...
entry_0:
  ;; emitting an 'if'
  %r0 = alloca %Object*
  ;; unboxing %Bool* @bool_true
  %r1 = getelementptr %Bool, %Bool* @bool_true, i32 0, i32 1
  %r2 = load i1, i1* %r1
  br i1 %r2, label %then_1, label %else_2
then_1:
  %r3 = bitcast %Int* @int_99 to %Object*
  store %Object* %r3, %Object** %r0
  br label %ifend_3
else_2:
  %r4 = bitcast %String* @string_3 to %Object*
  store %Object* %r4, %Object** %r0
  br label %ifend_3
ifend_3:
  %r5 = load %Object*, %Object** %r0
  ret %Int* @int_42
}
