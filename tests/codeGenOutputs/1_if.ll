...
entry_0:
  ;; unboxing %Int* @int_35
  %r0 = getelementptr %Int, %Int* @int_35, i32 0, i32 1
  %r1 = load i32, i32* %r0
  ;; unboxing %Int* @int_42
  %r2 = getelementptr %Int, %Int* @int_42, i32 0, i32 1
  %r3 = load i32, i32* %r2
...
then_1:
  ;; unboxing %Int* @int_42
  %r10 = getelementptr %Int, %Int* @int_42, i32 0, i32 1
  %r11 = load i32, i32* %r10
  ;; unboxing %Int* @int_35
  %r12 = getelementptr %Int, %Int* @int_35, i32 0, i32 1
  %r13 = load i32, i32* %r12
  %r14 = icmp slt i32 %r11, %r13
  ;; boxing i1 %r14
  %r15 = call %Bool* @Bool_new()
  %r16 = getelementptr %Bool, %Bool* %r15, i32 0, i32 1
  store i1 %r14, i1* %r16
  ;; emitting an 'if'
  %r17 = alloca %Int*
  ;; unboxing %Bool* %r15
  %r18 = getelementptr %Bool, %Bool* %r15, i32 0, i32 1
  %r19 = load i1, i1* %r18
  br i1 %r19, label %then_4, label %else_5
then_4:
  store %Int* @int_13, %Int** %r17
  br label %ifend_6
else_5:
  store %Int* @int_42, %Int** %r17
  br label %ifend_6
ifend_6:
  %r20 = load %Int*, %Int** %r17
  store %Int* %r20, %Int** %r7
  br label %ifend_3
else_2:
  store %Int* @int_14, %Int** %r7
  br label %ifend_3
ifend_3:
  %r21 = load %Int*, %Int** %r7
  ret %Int* %r21
