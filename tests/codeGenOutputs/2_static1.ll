...
@Parent_vtable_prototype = constant %Parent_vtable {
  ...
  %Int* (%Parent*, %Int*, %Int*, %Int*)* @Parent_getX
}
%Child = type {
  %Child_vtable*
}
...
define %Int* @Parent_getX(%Parent* %self, %Int* %a, %Int* %b, %Int* %c) {
entry_0:
  %r0 = alloca %Int*
  store %Int* %a, %Int** %r0
  %r1 = alloca %Int*
...
entry_0:
  ...
  %r1 = bitcast %Child* %r0 to %Parent*
  %r2 = call %Int* @Parent_getX(%Parent* %r1, %Int* @int_10, %Int* @int_20, %Int* @int_12)
  ret %Int* %r2
}
